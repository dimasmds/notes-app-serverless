...
class DomainToHttpErrorTranslator {
  static Directories: any = {
    ...
    'UPDATE_ATTACHMENT_USE_CASE.NOTE_NOT_FOUND': new NotFoundError('note is not found'),
    'UPDATE_ATTACHMENT_USE_CASE.USER_NOT_OWNER': new AuthorizationError('you are not allowed to access this note'),
  }
